...
-- 'holster': magic replaces the weapon (drawing one disables magic)
-- 'require': magic only works with a weapon in hand (original behaviour)
...
Config.Text = {
    on         = '~p~Dark magic~s~ awakened. Hold ~b~E~s~ to channel.',
